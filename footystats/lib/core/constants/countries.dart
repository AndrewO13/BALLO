/// ISO 3166-1 country codes and names for the onboarding country picker.
/// Flag emoji is derived from regional indicator symbols (code letters).
...
/// Returns country name for a 2-letter ISO country code, or the code if not found.
