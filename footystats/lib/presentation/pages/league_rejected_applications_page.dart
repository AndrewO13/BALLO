...
class LeagueRejectedApplicationsPage extends ConsumerStatefulWidget {
  const LeagueRejectedApplicationsPage({
    super.key,
  ...
  @override
  ConsumerState<LeagueRejectedApplicationsPage> createState() =>
      _LeagueRejectedApplicationsPageState();
}

class _LeagueRejectedApplicationsPageState
    extends ConsumerState<LeagueRejectedApplicationsPage> {
  String _searchQuery = '';
